...
export const styleSheet = `
  ...
  /* Pastille de disponibilite du hero */
  .status-badge {
  ...
  .status-dot {
    position: relative;
    /* flex-shrink: 0 sinon le texte du badge comprime la pastille et la rend ovale */
    flex: 0 0 auto;
    width: 8px; height: 8px; border-radius: 999px;
    background-color: ${palette.green};
  }
  /* L'onde est un pseudo-element anime en transform/opacity : contrairement a
     box-shadow, le compositeur s'en charge sans repeindre a chaque frame. */
  .status-dot::after {
    content: "";
